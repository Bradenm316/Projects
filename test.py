...
from testing.db_tests import test_init_db, test_get_inventory_exists, test_dict_factory_link, test_check_connection_threaded, test_cookies_and_cream_info, test_strawberry_covered_chocolate_info
...
DB_FUNCS = [test_init_db, test_get_inventory_exists,
            ...
            test_strawberry_covered_chocolate_info,
            test_cookies_and_cream_info
            ]
